...
if __name__ == "__main__":
    ...
    file = open("resources/final_model_sac_results_sv_all_test_without_sac.txt", 'w')
    ...
    file = open("resources/final_model_results_sv_filtered_test_without_sac.txt", 'w')
    file.write(str(score))
    file.write("\n")
    file.write(cm)
    file.close()
    ...
    df_test_with_prediction_production.to_csv("resources/df_test_with_prediction_production_data_without_sac.csv")

    df_test_with_prediction = copy.copy(df_test_f)
    df_test_with_prediction["prediction"] = y_pred_f

    df_test_with_prediction.to_csv("resources/df_test_filtered_with_prediction_without_sac.csv")
