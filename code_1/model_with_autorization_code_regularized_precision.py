        ...
        for power in powers:
            ...
            features_cleaning =  Pipeline(
                [('clean_text_sr', CleanText("StatuteReason")),
                 ...
                 ('encode_sac', EncodeSACRegPrecision(feature_name="SearchAuthorizationCode", threshold=treshold, power=power)),
            ...
            file = open("resources/final_model_with_sac_regularization_precision_results_" + str(treshold) + "_" + str(power) + ".txt", 'w')
            ...
            df_test_with_prediction.to_csv("resources/df_test_with_prediction_with_sac_regularization_precision_" + str(treshold) + "_" + str(power) + ".csv")
